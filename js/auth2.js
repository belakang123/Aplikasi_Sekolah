...
function setupCacheControl() {
    if (!window.location.pathname.includes('../login-ortu.html')) {
...
function logout() {
    ...
    window.location.replace('login-ortu.html');
...
document.addEventListener('visibilitychange', function() {
    if (!document.hidden && !window.location.pathname.includes('login-ortu.html')) {
        checkAuth();
    }
});
